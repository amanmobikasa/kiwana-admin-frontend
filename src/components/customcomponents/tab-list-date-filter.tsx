...
export const TabListDateFilter = ({}: TabListDateFilterProps) => {
  ...
  console.log("added_product_object", added_product_object);


  useEffect(()=>{
    // enter all the logic of update the table.
    if(added_product_object){
      // debugger;
  ...
  console.log("product management json state", ProductManagementJsonState);
